...
数学*证明*是用以证实定理、引理及断言真实性的论证过程. 我们将在下文[1.5节](#15-证明)讨论证明, 其核心在于数学证明的标准极为严苛. 与其他领域不同, 数学证明必须是"无懈可击"的论证, 确保证明对象无可置疑为真. 本节涉及的数学证明示例参见{{ref:exec:simplepathex}}及[1.6节](#16-扩展示例: 拓扑排序). 如前言所述, 总体而言: 理解**定义**比掌握**定理**更重要, 理解**定理陈述**比掌握其**证明过程**更重要. 
